...
def test_platform_demo_assets_are_versioned_and_cacheable() -> None:
    with TestClient(app) as client:
        ...
        js = client.get("/platform/assets/app.js?v=20260309as")
        dataset = client.get("/platform/data/demo_dataset.json?v=20260309as")

    assert html.status_code == 200
    assert 'src="assets/app.js?v=20260309as"' in html.text
    assert 'href="assets/app.css?v=20260309as"' in html.text
    assert 'src="vendor/chart.umd.min.js?v=20260309as"' in html.text
