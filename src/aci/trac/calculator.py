...
Near-term value: pricing data-quality risk. Carbon remains available as an
optional accounting line item when enabled explicitly in configuration.
"""
...
class TRACCalculator:
    ...
    - Carbon Liability: optional emissions * internal_carbon_price / 1000.
    ...
    def compute(
        ...
        # Component 1: optional carbon liability.
        carbon_liability = 0.0
        if self.trac_config.include_carbon_liability:
            # emissions_kg * price_per_tonne / 1000 (converting kg to tonnes).
            carbon_liability = (
                emissions_kg_co2e * self.trac_config.carbon_price_per_tco2e / 1000.0
            )
        ...
        # TRAC = billed cost + risk premium (+ optional carbon liability).
