...
class TRACResult(BaseModel):
    ...
    Carbon can be included as an explicit accounting line item when enabled.
    """
    ...
    trac_usd: float = Field(description="Sum of billed cost, risk premium, and optional carbon")
