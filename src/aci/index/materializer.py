...
class AttributionIndexStore:
    ...
    def snapshot_entries(self) -> list[AttributionIndexEntry]:
        """Read-only snapshot of locally materialized entries for dashboard reporting."""
        with self._lock:
    ...
    def _load_durable_entry(self, workload_id: str) -> AttributionIndexEntry | None:
        ...
        try:
            ...
            # Fallback for string-valued durable entries.
